...
import 'package:kamus_arab/Kamus/Ziyadah/Ziyadah_2.dart';
import 'package:kamus_arab/Kamus/Ziyadah/Ziyadah_2_S.dart';
import 'package:back_button_interceptor/back_button_interceptor.dart';

import 'detail_3_a.dart';

class Detail_3 extends StatelessWidget {
  const Detail_3({super.key});
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  bool myInterceptor(bool stopDefaultButtonEvent, RouteInfo info) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => const Ziyadah_2_S()),
    );
                          ...
                          child: Center(
                            ...
                            Center(
                              ...
                              child: Container(
                                  ...
                                  decoration: const BoxDecoration(
                                      image: DecorationImage(
                                    image: AssetImage('assets/image/127.png'),
                                    fit: BoxFit.fitHeight,
                                  ))),
                            )),
                            Center(
